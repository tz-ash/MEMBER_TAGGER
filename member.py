...
async def start(event):
  await event.reply("** I am Mentione Bot **, I can Tag almost all members in group or channel 🤓\nClick **/help** for more infomation.\n\n Here is my [Developer👨‍💻](https://t.me/kidhub)",
                    buttons=(
                      [Button.url('🌈 UPDATE CHANNEL', 'https://t.me/kidbots')]
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**Hey 👽 I Am Mentione Bot \n\n You can Tag members by using Commands shown below,\n\n /all text \n\n @all text \n\n #all text**"
